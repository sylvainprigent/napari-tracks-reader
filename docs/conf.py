# -*- coding: utf-8 -*-
#
# napari-tracks-reader documentation build configuration file, created by
...
project = u'napari-tracks-reader'
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'napari-tracks-reader Documentation',
     [author], 1)
]
